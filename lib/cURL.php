 ...
 *
 *          I make no claim of authorship. This is a simple implementation of code almost exactly as-is from the original
 *          source, simply altered to work with Dependency Injection within the confines of its intended use.
 *
...
class cURL
{
    ...
    const USER_AGENT = 'Litwicki-CURL';
    ...
    protected function exec($_ch = NULL)
    {
        ...
        $ch->http_error = in_array(floor($ch->http_status_code / 100), array(
                4,
                5
            ));
